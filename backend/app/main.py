...
from .routes import auth_routes, employee_routes, shift_routes, leave_routes, shift_entry_routes, reports_routes, project_routes, notification_routes, contributor_routes, overview_routes, client_routes
